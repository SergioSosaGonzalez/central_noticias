    ...
    browserConfig: {
        ...
        'bundles': {
            'assets/js/app.js': [
                ...
                'npm:emojionearea@3.1.5/dist/emojionearea.js',
                'npm:emojionearea@3.1.5.json',
                ...
                'npm:screenfull@3.2.0/dist/screenfull.js',
                'npm:screenfull@3.2.0.json',
                ...
                'npm:popper.js@1.12.3/dist/umd/popper.js',
                'npm:popper.js@1.12.3.json'
            ],
            'assets/js/chat.js': [
            ...
            'assets/js/dash2.js': [
                ...
                'npm:slick-carousel@1.6.0/slick/slick.js',
                'npm:slick-carousel@1.6.0.json',
            ...
            'assets/js/photo.js': [
                ...
                'npm:cropperjs@1.0.0-rc.2/dist/cropper.js',
                'npm:cropperjs@1.0.0-rc.2.json'
            ],
            'assets/js/form-addon.js': [
                ...
                'reactiveadmintemplate/scripts/modules/form/slider.js',
                'npm:moment@2.18.1/moment.js',
                'npm:moment@2.18.1.json',
                'npm:ion-rangeslider@2.1.7/js/ion.rangeSlider.js',
                'npm:ion-rangeslider@2.1.7.json',
                ...
                'npm:inputmask@3.3.6/dist/inputmask/inputmask.extensions.js',
                'npm:inputmask@3.3.6.json',
                'npm:inputmask@3.3.6/dist/inputmask/inputmask.date.extensions.js',
                'npm:inputmask@3.3.6/dist/inputmask/jquery.inputmask.js',
                'npm:inputmask@3.3.6/dist/inputmask/inputmask.js',
            ...
            'assets/js/table.js': [
                ...
                'npm:tableexport.jquery.plugin@1.9.0/tableExport.min.js',
                'npm:tableexport.jquery.plugin@1.9.0.json',
...
SystemJS.config({
    ...
    map: {
        ...
        'chartjs': 'npm:chart.js@2.6.0',
        'child_process': 'npm:jspm-nodelibs-child_process@0.2.1',
        'colorpicker': 'npm:spectrum-colorpicker@1.8.0',
        'constants': 'npm:jspm-nodelibs-constants@0.2.0',
        'cropperjs': 'npm:cropperjs@1.0.0-rc.2',
        ...
        'emojionearea': 'npm:emojionearea@3.1.5',
        ...
        'inputmask': 'npm:inputmask@3.3.6',
        'ionicons': 'npm:ionicons@2.0.1',
        'ionrangeslider': 'npm:ion-rangeslider@2.1.7',
        ...
        'tableexport.jquery.plugin': 'npm:tableexport.jquery.plugin@1.9.0',
    ...
    packages: {
        ...
        'npm:tableexport.jquery.plugin@1.9.0': {
            'map': {
