...
class CdPost extends \Phalcon\Mvc\Model
{
    ...
    {
        $this->setSchema("cd_red");
        $this->setSource("cd_post");
     ...
     * @return CdPost[]|CdPost|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return CdPost|\Phalcon\Mvc\Model\ResultInterface
     */
