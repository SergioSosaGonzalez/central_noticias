...
class Cdapired extends \Phalcon\Mvc\Model
{
     ...
     * @Column(type="string", nullable=true)
     */
    protected $breaking_new_time_end;
    ...
    /**
     * Method to set the value of field description_image
     *
     * @param string $description_image
     * @return $this
     */
    ...
    /**
     * Method to set the value of field breaking_new_time_end
     *
     * @param string $breaking_new_time_end
     * @return $this
     */
    public function setBreakingNewTimeEnd($breaking_new_time_end)
    {
        $this->breaking_new_time_end = $breaking_new_time_end;
    ...
    /**
     * Returns the value of field description_image
     *
     * @return string
     */
    ...
    /**
     * Returns the value of field breaking_new_time_end
     *
     * @return string
     */
    public function getBreakingNewTimeEnd()
    {
        return $this->breaking_new_time_end;
    }
     ...
     * @return Cdapired[]|Cdapired|\Phalcon\Mvc\Model\ResultSetInterface
     */
     ...
     *
     * @param mixed $parameters
     * @return Cdapired|\Phalcon\Mvc\Model\ResultInterface
     */
