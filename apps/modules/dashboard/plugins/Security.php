    ...
    public function getAcl(){
        ...
        if(!isset($this->persistent->acl)){ /* update values here */
            ...
            $adminResources = array(
                ...
                "news"=>array("index","createnew","nuevanoticia","editnew","updatenew","deletenew","newenterprise","positionslider")
            );
            ...
            $userResources = array(
                ...
                "user"=>array('index',"ajax","lista","ajaxconsulta","ajaxactualizar","ajaxdelete","email","username","password"),
